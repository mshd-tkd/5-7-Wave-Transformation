   ...
   [SPECTRAL_WAVE_MODULE]
      ...
      [BOUNDARY_CONDITIONS]
         ...
         [CODE_3]
            ...
            type = 2
            format = 0
            constant_values = 11.877, 15.4, 270.0, 4.0, 0.1, 16.0, 270.0, 32.0
            file_name = ||
            item_numbers = 1, 1, 1, 1, 200828164, 173520459, 0, 0
            item_names = '', '', '', '', '', '', '', ''
            type_of_soft_start = 1
            soft_time_interval = 0.0
            reference_values = 0.0, 15.4, 270.0, 4.0, 0.0, 16.0, 270.0, 32.0
            type_of_time_interpolation = 1, 1, 1, 1, 1, 1, 1, 1
            type_of_space_interpolation = 1
            code_cyclic = 0
            reflection_coefficient = 1.0
